...
public class Global implements Frame {
  ...
  @Deprecated
  public boolean exists(String _name){ return primitives.containsKey(_name); }
  @Deprecated
  public Object get(String _name){ return primitives.get(_name); }
  @Override
  public Runtime.Variable local(String _name) { return variables.get(_name); }

  @Override
  public void put(String name, Runtime.Variable head, Object value) {
    long hash_code;
    if(Objects.nonNull(value)) {
      if( Utils.isType(head, VmyTypes.BuiltinType.Table) &&
  ...
  @Override
  public Object get_obj(Long identity) { return objPool.get(identity); }
}
